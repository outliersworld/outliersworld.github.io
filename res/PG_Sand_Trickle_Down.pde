...
/* @pjs preload="maestros/apj-min.png" */   
/* @pjs preload="maestros/rabindranath-min.png" */   
/* @pjs preload="maestros/swami-min.png" */   
/* @pjs preload="maestros/tata-min.png" */   
/* @pjs preload="maestros/rk-min.png" */   
/* @pjs preload="maestros/homi-min.png" */   
